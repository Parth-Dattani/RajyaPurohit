    ...
    Widget _buildHeroWebLayout(BuildContext context) {
      ...
      return Obx(() {
        return Column(
          ...
          children: [
            // ➔ ૧. મેઈન સેક્શન: શરૂઆતનો ઇતિહાસ અને જમણી બાજુ દાદાનો ફોટો
            Container(
              height: baseHeight,
              ...
              child: Row(
                ...
                children: [
                  ...
                  // જમણી બાજુ: ભગવાન પરશુરામની ઈમેજ (ગ્રેડિયન્ટ બેકગ્રાઉન્ડ)
                  Expanded(
                    flex: 8,
                    child: Container(
            ...
            // ➔ ૨. બાકીનો બધો જ ઇતિહાસ ફુલ્લી ઓપન થશે વેબમાં
            AnimatedSize(
              ...
              child: controller.isHistoryExpanded.value
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 15),
                    _buildExtendedHistoryText(
                      'લાલપુર વિસ્તારના ચેલા ચંગા, હરિપર, મેમાણા, ખીરસરા, ભણગોર સહિતના ગામોમાં પણ રાજગોર પરિવારો રાજના ગોર તરીકે ઓળખાય છે. સમય જતાં આ પરિવારો જામનગર અને ખંભાળિયા ઉપરાંત રાજકોટ, મોરબી, ગોંડલ, જુનાગઢ, મુંબઈ, આફ્રિકા, લંડન અને અન્ય સ્થળોએ સ્થાયી થયા. શિક્ષણ, વેપાર-ઉદ્યોગ, સરકારી સેવા, રાજકારણ અને વિવિધ વ્યવસાયોમાં તેમણે નોંધપાત્ર પ્રગતિ હાંસલ કરી છે.',
                      isMobile: false,
                    ),
                    const SizedBox(height: 15),
                    _buildExtendedHistoryText(
                      'રાજગોર જ્ઞાતિમાં અનેક શાખાઓ અને અટકો જોવા મળે છે. લોકવાયકા મુજબ કલો, ખેતો, ગોપો અને પુંજો નામના ચાર મુખ્ય વડવાઓના વંશજો ક્રમે કલ્યાણી, ખેતીયા, ગોપિયાણી અને પુંજાણી તરીકે ઓળખાયા. આ ઉપરાંત ભટ્ટ, બારોટ, નાકર, જોશી, લવા, પંડ્યા, આશા, રાવલ, વાસુ, ખેતાણી, પારાકડા, વીઠા, કેશવાણી વગેરે અટકો ધરાવતા પરિવારો પણ જ્ઞાતિમાં મહત્વનું સ્થાન ધરાવે છે. આ સિવાય મોખા, મેતા, મોતા અને કેવલીયા પરિવાર પણ રાજગોર જ્ઞાતિનો અભિન્ન ભાગ છે અને જ્ઞાતિના સામાજિક તથા સાંસ્કૃતિક વિકાસમાં તેમનું પણ મહત્વપૂર્ણ યોગદાન રહ્યું છે.',
                      isMobile: false,
                    ),
                    const SizedBox(height: 15),
                    _buildExtendedHistoryText(
...
// ==========================================
// 🔹 ⚡ મોટો ફિક્સ: મોબાઇલ લેઆઉટ એકદમ ટકાટક ક્લીન કર્યો ભાઈ!
// ==========================================
    Widget _buildHeroMobileLayout() {
      return Column(
        children: [
          ...
          // ➔ ⚡ અહીંયા મોટો જાદુ: મોબાઇલ માટે પેલો મોટો ફિક્સ બોક્સ હટાવીને ઈમેજને નેચરલ લુક આપ્યો ભાઈ!
          Container(
            width: double.infinity,
